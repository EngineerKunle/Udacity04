...
var resizePizzas = function (size) {
   ...
   //P4 - replace querySelector with getElementById to improve performance
   ...
   //P4: replace the variable windowWidth; querySelector with getElementById to improve performance
   ...
   //P4: replace queryselector with getElementsByClassName inside the changePizzaSizes function
   //P4: removed dx and newwidth variable out of loop, just needs to be calculated once 
...
//P4: replaced QuerySelecotr with getClassName
//P4: Optimised by putting items.length in a variable
//P4: removed the var phase outside loop to help improve performance 
...
//P4 to optimised the code to help, storing the values in an Array to be used in the function below  
  for (var i = 0; i < 5; i++) {
...
//p4 task created a variable for getElementId for movingPizzas1 line 529
//p4 reduce number of Pizzas to 50 to help reduce performance
document.addEventListener('DOMContentLoaded', function () {
   var cols = 8;
   var s = 256,
      getIdParent = document.getElementById("movingPizzas1");
   for (var i = 0; i < 50; i++) {
      ...
      //P4 optimise - use getElementById as movingPizzas1 is an id.
      getIdParent.appendChild(elem);
   }
   updatePositions();
});